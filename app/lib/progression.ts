...
export const xpGuideItems: XpGuideItem[] = [
  ...
  },
  {
    source: "buy_card",
    label: "Buy a card",
    activityLabel: "Bought a card",
    xp: xpSources.buy_card,
    status: "coming_soon",
    rule: "Will be awarded after buyer XP hooks are connected to completed orders.",
  },
  {
    source: "sell_card",
    label: "Sell a card",
    activityLabel: "Sold a card",
    xp: xpSources.sell_card,
    status: "coming_soon",
    rule: "Will be awarded after seller XP hooks are connected to completed orders.",
  },
  {
    source: "win_auction",
    ...
    status: "coming_soon",
    rule: "Will be awarded after auction-win XP hooks are connected.",
  },
  {
  ...
  },
  {
    ...
    status: "coming_soon",
    rule: "Will be awarded after first-purchase checks are connected.",
  },
  {
    ...
    status: "coming_soon",
    rule: "Will be awarded after first-sale checks are connected.",
  },
];

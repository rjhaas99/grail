...
type ListingTag = "Grail" | "Hot" | "Graded" | "Raw";
...
function buildSellerListings(seller: Seller) {
  return baseListings
    .map((listing, index) => ({
      ...listing,
      price: Math.max(75, listing.price + seller.priceOffset + index * 12),
      marketValue: Math.max(95, listing.marketValue + seller.priceOffset + index * 10),
      watchCount: Math.max(18, listing.watchCount + Math.round(seller.levelProgress / 6) - index * 2),
    }))

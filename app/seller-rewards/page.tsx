    ...
    <main className="rewards-page">
      ...
      <div className="rewards-shell">
        ...
        <section className="hero-card panel">
          ...
          <p className="badge-note">Seller badges appear next to your username across GRAIL.</p>
        </section>

        <section className="content-layout">
          <div className="panel section-card">
            <h2>Seller Levels & Badges</h2>
          ...
          <aside className="side-stack">
            ...
            <section className="panel section-card">
              <h2>Your Progress</h2>
              <Metric label="Rank This Week" value="#18" />
              <Metric label="Views from Browse" value="4,820" />
              <Metric label="Conversion" value="3.1%" />
            </section>
          </aside>
        </section>
      </div>
...
const pageStyles = `
  ...
  .hero-card { margin-top: 18px; padding: 20px; display: grid; grid-template-columns: 330px 1fr; gap: 18px; align-items: center; }
  ...
  .badge-note { grid-column: 1 / -1; margin: 0; border-top: 1px solid #202026; padding-top: 14px; color: #C9CDD3 !important; }
  .metric {
  ...
  .content-layout { margin-top: 18px; display: grid; grid-template-columns: minmax(0, 1fr) 310px; gap: 16px; align-items: start; }
  .section-card { padding: 18px; }
  .section-card h2 { margin: 0; color: #fff; font-size: 20px; line-height: 24px; font-weight: 900; }
  .level-grid { margin-top: 14px; display: grid; grid-template-columns: 1fr; gap: 10px; }
  .level-card {
    border: 1px solid #202026; border-radius: 10px; background: rgba(8,8,10,0.76); padding: 14px;
  }
  .level-card.active { border-color: rgba(231,222,208,0.54); box-shadow: 0 0 20px rgba(201,205,211,0.14); }
  .level-heading { display: flex; align-items: center; justify-content: space-between; gap: 12px; }
  .level-card span { color: #E7DED0; font-size: 12px; font-weight: 900; text-transform: uppercase; }
  .level-card em { border: 1px solid rgba(231,222,208,0.28); border-radius: 999px; background: rgba(231,222,208,0.06); color: #fff; padding: 5px 9px; font-size: 11px; font-style: normal; font-weight: 900; white-space: nowrap; }
